...
// response_mime_type.dart
class ResponseMimeType {
  final String value;
  const ResponseMimeType._(this.value);

  static const textPlain = ResponseMimeType._('text/plain');
  static const applicationJson = ResponseMimeType._('application/json');

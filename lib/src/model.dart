...
/// Configuration for how a [GeminiApiModel] makes requests.
///
...
final class GeminiApiModel {
  ...
  /// Create a [GeminiApiModel] backed by the generative model named [model].
  ///
  ...
  /// [GeminiApiModel.new] constructor. Each argument, when non-null,
...
extension VertexExtensions on GeminiApiModel {
...
GeminiApiModel createModelWithClient({
  required String model,
  required ApiClient client,
  List<SafetySetting> safetySettings = const [],
  GenerationConfig? generationConfig,
...
GeminiApiModel createModelWithBaseUri({
  required String model,
  required String apiKey,
  required Uri baseUri,
